        ...
        <tr data-id="${student.id}">
            ...
            <td>
                <div class="action-btns">
                    <button class="action-btn del delete-student" data-id="${student.id}" title="Delete Student"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M3 6h18"/>
